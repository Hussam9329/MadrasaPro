...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Error Message */}
      {error ? (
        <div className="rounded-[24px] border border-red-200 bg-gradient-to-l from-red-50 to-blue-50 p-4 shadow-sm dark:border-red-800/40 dark:from-red-950/30 dark:to-blue-950/30">
      ...
      <label className="flex cursor-pointer items-start gap-3 rounded-[24px] border border-[var(--app-border-soft)] bg-[var(--app-card-soft)] p-4 shadow-sm transition hover:border-blue-200 hover:bg-white/80 dark:hover:bg-[var(--app-card-soft)]">
        <input
          name="rememberMe"
          type="checkbox"
          className="mt-1 h-4 w-4 rounded border-[var(--app-border)] accent-blue-700"
          disabled={isPending}
        />
        <span>
