    ...
    <AppShell>
      <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-6">
        <section className="grid gap-5 xl:grid-cols-[1.42fr_0.58fr]">
          ...
          <div className="relative overflow-hidden rounded-[var(--radius-xl)] p-px">
            <div className="absolute inset-0 bg-gradient-to-l from-indigo-500/20 via-amber-500/10 to-indigo-500/20" />
            <div className="app-card relative min-h-[260px] p-6 sm:p-8">
              <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="relative overflow-hidden rounded-3xl border border-indigo-300/30 bg-gradient-to-br from-blue-600 via-indigo-600 to-amber-500 p-5 text-white shadow-xl shadow-indigo-900/20 lg:min-w-[260px]">
                  {/* Decorative circles */}
                  ...
                  <div className="relative">
                    ...
                    <a
                      href="/subjects"
                      className="mt-5 inline-flex h-11 items-center justify-center rounded-2xl bg-white px-5 text-sm font-extrabold text-blue-700 shadow-lg shadow-indigo-900/20 transition hover:bg-indigo-50 hover:shadow-xl"
                    >
                      إضافة أول مادة
                    </a>
                  </div>
          ...
          {/* Warning card */}
          <div className="app-card min-h-full p-6">
            <div className="flex items-start gap-3">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-50 to-orange-100 text-amber-700 shadow-sm">
              ...
              {setupSteps.map((step, index) => (
                <div
                  ...
                  className={[
                    ...
                    step.active
                      ? "border-blue-200 bg-gradient-to-l from-white via-blue-50/80 to-amber-50/60"
                ...
                >
                  <div
                    className={[
                      ...
                      step.active
                        ? "bg-gradient-to-br from-blue-600 via-indigo-500 to-amber-400 text-white shadow-md shadow-indigo-500/25"
...
function getToneClass(tone: string) {
  const tones: Record<string, string> = {
    ...
    emerald: "bg-gradient-to-br from-emerald-50 to-teal-100 text-emerald-700 shadow-sm",
    violet: "bg-gradient-to-br from-amber-100 to-indigo-100 text-indigo-700",
    amber: "bg-gradient-to-br from-amber-50 to-orange-100 text-amber-700 shadow-sm",
